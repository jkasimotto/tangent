...
export { agentCommandSpec, areaCommandSpec, brainCommandSpec, documentCommandSpec, goalCommandSpec, harnessCommandSpec, processCommandSpec, sendCommandSpec, shellCommandSpec, studyCommandSpec, vaultCommandSpec } from "./spec.js";
