...
@tangent/agent-shell -> @tangent/core, @tangent/agent-runtime, @tangent/repo, React, Excalidraw   (CLI: HTTP client through app/gateway.mjs to app/server.mjs; browser: one composed Area-map world; server: exact multi-shard Git transactions)
