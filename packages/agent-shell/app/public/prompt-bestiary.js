...
export const MODEL_CONCEPTS = [
  ...
  concept("brain", "Brain", "Control", "A brain normally changes only its Area tree. Julian can directly instruct the active brain to change another Area. Agent messages and Documents never grant this authority; an approved Request authorizes only its exact proposal.", "One Area tree, unless Julian gives a direct instruction", "Its record survives stopped sessions and new generations. Direct cross-Area authority does not.", ["Area", "Goal", "Pipeline", "Request"]),
