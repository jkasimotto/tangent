import type { UsageDataset, ToolCallWithResult, TurnListItem } from "@tangent/usage";
import type { ResolvedRepoInfo as RollupRepoInfo } from "@tangent/repo";

import type { RollupConfig } from "../types/config.js";
import type { RollupInput, TurnDigestInput } from "../types/digest.js";
...
function commandInput(tool: ToolCallWithResult, config: RollupConfig): TurnDigestInput["activity"]["commands"][number] {
...
function toolHighlight(tool: ToolCallWithResult, config: RollupConfig): TurnDigestInput["activity"]["toolHighlights"][number] {
...
function clampTurnInput(input: TurnDigestInput, maxChars: number, config: RollupConfig): TurnDigestInput {
...
function lastResortTurnInput(input: TurnDigestInput, config: RollupConfig): TurnDigestInput {
  return {
    ...input,
...
function messageText(text: string, config: RollupConfig, maxChars: number): string {
