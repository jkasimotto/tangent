...
const records = [
  ...
  { id: "fold", keyDisplay: "z", ariaKeyshortcuts: "z", scope: "area", kind: "action", palette: true, label: "Fold / expand Area", help: "Fold or expand this Area's Work rows.", shortcuts: [{ key: "z" }] },
  ...
  { id: "complete", keyDisplay: "x", ariaKeyshortcuts: "x", scope: "goal", kind: "action", palette: true, label: "Complete Goal", help: "Mark the current Goal complete after confirmation.", shortcuts: [{ key: "x" }] },
