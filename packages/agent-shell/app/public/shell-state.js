...
export function createShellState(storage = globalThis.localStorage, href = globalThis.location.href) {
  ...
  const state = {
    ...
    launch: { area: "", kind: "", options: null, loading: false, choice: null, command: "", editing: false, open: false, instruction: "", assignmentKind: "implementation", assignmentPath: "", continueFrom: null, steps: [], active: 0, record: null, stale: null, queueMutation: null, replacement: null },
