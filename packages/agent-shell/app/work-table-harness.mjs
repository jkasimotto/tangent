 ...
 */
export async function bootWorkTable(fixture, { workFilter = "active", width = 1440, areaFocus = [], areaFocusOnly = false, workProjection = null, workState = "current", workHandler = null, launchOptions = null, harnessRegistry = null, goalDetail = null, jobDetail = null, documentRecord = null, areaCanvas = null, navigationSearch = null, postHandler = null, localStorageEntries = {}, terminalStandin = false, mapDocumentRef = "", startSurface = "work" } = {}) {
