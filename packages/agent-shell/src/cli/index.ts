...
export { agentCommandSpec, areaCommandSpec, brainCommandSpec, documentCommandSpec, goalCommandSpec, jobCommandSpec, harnessCommandSpec, processCommandSpec, sendCommandSpec, shellCommandSpec, studyCommandSpec, vaultCommandSpec } from "./spec.js";
