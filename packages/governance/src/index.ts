...
import { lintWorkReadModelBoundary } from "./work-read-boundary.js";
...
const allowedPackageDeps: Record<string, string[]> = {
  ...
  "@tangent/agent-shell": ["@tangent/core", "@tangent/agent-runtime", "@tangent/pricing", "@tangent/repo"],
  ...
  "@tangent/usage": ["@tangent/core", "@tangent/pricing", "@tangent/repo", "@tangent/ui-server", "@tangent/usage-core", "@tangent/usage-index-sqlite", "@tangent/usage-providers", "@tangent/usage-ui", "@tangent/usage-ui-data"],
  "@tangent/ui-tokens": [],
  ...
  "@tangent/eval": ["@tangent/core", "@tangent/pricing", "@tangent/repo", "@tangent/agent-runtime", "@tangent/usage-core", "@tangent/usage-index-sqlite", "@tangent/ui-server", "@tangent/eval-ui"],
...
async function lintAgentShellWorkflowContracts(ctx: LintContext): Promise<GovernanceFinding[]> {
  ...
  findings.push(...await lintWorkReadModelBoundary(ctx.root));
