...
const records = [
  ...
  { id: "dismissPresentation", keyDisplay: "x", ariaKeyshortcuts: "x", scope: "document", kind: "action", label: "Dismiss", help: "Withdraw this presentation without opening the Document.", shortcuts: [{ key: "x" }] },
