...
- The Agent Shell package owns the Area Excalidraw scene parser, migration, repository, HTTP boundary, bundled editor island, and disposable map records. No other vertical package writes Area scenes (ADR-0049).
