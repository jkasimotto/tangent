...
- The Agent Shell package owns the Area Excalidraw source shards and their composed browser world. It also owns identity mapping, containment, history, migration, transactions, recovery, and world HTTP routes. No other vertical package writes Area scenes (ADR-0049, ADR-0051).
