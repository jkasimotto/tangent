...
const records = [
  ...
  { id: "session", keyDisplay: "⌘⇧↵", ariaKeyshortcuts: "Meta+Shift+Enter", scope: "work", kind: "navigation", label: "Enter live session", help: "Open or close the live session for the current row.", shortcuts: [{ key: "Enter", metaKey: true, shiftKey: true }] },
