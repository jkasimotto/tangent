...
export { agentCommandSpec, areaCommandSpec, brainCommandSpec, documentCommandSpec, goalCommandSpec, handoverCommandSpec, harnessCommandSpec, ideaCommandSpec, processCommandSpec, sendCommandSpec, shellCommandSpec, studyCommandSpec, vaultCommandSpec } from "./spec.js";
