...
- The Agent Shell package owns the Area canvas parser, repository, HTTP boundary, board, and disposable map records. No other vertical package writes Area canvases (ADR-0048).
